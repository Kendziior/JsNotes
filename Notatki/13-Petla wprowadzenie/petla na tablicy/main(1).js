...
//     console.log(`wiek uzytkownika nr ${i} to ${usersAge[i]} `)
// }
...
//     console.log(`wiek uzytkownika o index  ${i} w roku ${currentYear} wynosi ${currentYear - usersDateBirth[i]}`);
// }
...
//         console.log('Uwaga PROGRAMISTA ! nerdów nie wpuszczamy');
//     } else if (guest[i] === "polityk") {
//         console.log("polirtyczne scierwo nie wpuszczac ! ");
//     } else {
