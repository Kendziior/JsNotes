...
//     console.log(text)
// };
// const showMeArrow = (typNumber) => {
//     console.log(typNumber);
// }

// showMeArrow('pokaz nam tym Number');

// showMeTextMyArrowFunction("hejjjj!");


const exampleFunction = function (x, y, z) {
    return x + y / z;

}
const newValue = exampleFunction(10, 20, 2);
